    ...
    return (
        <div className="content">
            <div className="content__inner">
                <h1 className="content__title">{searchValue ? `Search by: "${searchValue}"` : 'All Sneakers'}</h1>
                <div className="search-block">
                    ...
                    {searchValue && <img onClick={() => setSearchValue('')} className="clear" width={25} height={25} src={`${process.env.PUBLIC_URL}/img/icons/btn-remove.svg`} alt="button" />}
